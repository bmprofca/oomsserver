CREATE TABLE IF NOT EXISTS `sms_fast2sms_campaign_schedules` (
  ...
  `variables_values` text DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_sms_schedule_id` (`schedule_id`),
  KEY `idx_sms_sched_branch_active` (`branch_id`, `is_active`),
  KEY `idx_sms_sched_last_run_key` (`last_run_key`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

CREATE TABLE IF NOT EXISTS `sms_fast2sms_campaign_schedule_runs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_sms_run_id` (`run_id`),
  KEY `idx_sms_schedule_run` (`schedule_id`, `run_at`),
  KEY `idx_sms_branch_run` (`branch_id`, `run_at`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
