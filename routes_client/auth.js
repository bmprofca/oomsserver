...
router.post("/login/send-otp", async (req, res) => {
    ...
    try {
        ...
        await conn.execute(
            `UPDATE otps
             ...
             WHERE country_code = ?
               ...
               AND type = ?
               AND status = ?`,
            ["1", normalizedCountryCode, normalizedMobile, CLIENT_OTP_TYPE, "0"]
        );
        ...
        console.error("CLIENT LOGIN SEND OTP ERROR:", err);
    ...
    try {
        ...
        const [otpRows] = await conn.query(
            `SELECT id
             ...
             ORDER BY id DESC
             LIMIT 1`,
            [normalizedCountryCode, normalizedMobile, CLIENT_OTP_TYPE, String(otp), "0"]
        );
        ...
        const username = clientProfile.username;
