...
// Premium Modern Receive Template
export function renderReceivePremiumModern(doc, t, {
    title,
    invoice,
    transactionRow,
    lines = [],
    ...
    // Header
    doc.rect(left, 20, fullW, 85).fill("#0d47a1");
    doc.fillColor("#ffffff").font("Helvetica-Bold").fontSize(28)
        .text("RECEIPT VOUCHER", left + 25, 45, { width: fullW - 50 });
    doc.font("Helvetica").fontSize(10).fillColor("#e0e0e0")
        .text("Money Receipt", left + 25, 80);
    ...
    doc.fillColor("#6c757d").font("Helvetica-Bold").fontSize(8)
        .text("RECEIPT NUMBER", left + 27, metaY + 12);
    doc.fillColor("#0d47a1").font("Helvetica-Bold").fontSize(12)
        .text(String(invoice.invoice_no || "-"), left + 27, metaY + 32);
    
    doc.roundedRect(left + cardWidth + 25, metaY, cardWidth, 55, 8).fill("#f8f9fa");
    doc.fillColor("#6c757d").font("Helvetica-Bold").fontSize(8)
        .text("RECEIPT DATE", left + cardWidth + 37, metaY + 12);
    doc.fillColor("#0d47a1").font("Helvetica-Bold").fontSize(12)
    ...
    doc.roundedRect(totalsX, y, totalsWidth, 80, 8).fill("#e3f2fd");
    doc.rect(totalsX, y, totalsWidth, 4).fill("#0d47a1");
    
    doc.fillColor("#0d47a1").font("Helvetica-Bold").fontSize(13)
        .text("RECEIVED AMOUNT:", totalsX + 20, y + 25);
    doc.fillColor("#0d47a1").font("Helvetica-Bold").fontSize(18)
...
export const receivePremiumRenderers = {
    premium_modern: renderReceivePremiumModern,
};