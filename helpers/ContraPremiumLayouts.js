...
// Premium Modern Contra Template
export function renderContraPremiumModern(doc, t, {
    title,
    invoice,
    transactionRow,
    lines = [],
    ...
    // Header
    doc.rect(left, 20, fullW, 85).fill("#e65100");
    doc.fillColor("#ffffff").font("Helvetica-Bold").fontSize(28)
        .text("CONTRA VOUCHER", left + 25, 45, { width: fullW - 50 });
    doc.font("Helvetica").fontSize(10).fillColor("#e0e0e0")
        .text("Transfer Voucher", left + 25, 80);
    ...
    doc.fillColor("#6c757d").font("Helvetica-Bold").fontSize(8)
        .text("CONTRA NUMBER", left + 27, metaY + 12);
    doc.fillColor("#e65100").font("Helvetica-Bold").fontSize(12)
        .text(String(invoice.invoice_no || "-"), left + 27, metaY + 32);
    
    doc.roundedRect(left + cardWidth + 25, metaY, cardWidth, 55, 8).fill("#f8f9fa");
    doc.fillColor("#6c757d").font("Helvetica-Bold").fontSize(8)
        .text("TRANSFER DATE", left + cardWidth + 37, metaY + 12);
    doc.fillColor("#e65100").font("Helvetica-Bold").fontSize(12)
    ...
    doc.roundedRect(totalsX, y, totalsWidth, 80, 8).fill("#fff3e0");
    doc.rect(totalsX, y, totalsWidth, 4).fill("#e65100");
    
    doc.fillColor("#e65100").font("Helvetica-Bold").fontSize(13)
        .text("TRANSFER AMOUNT:", totalsX + 20, y + 25);
    doc.fillColor("#e65100").font("Helvetica-Bold").fontSize(18)
...
export const contraPremiumRenderers = {
    premium_modern: renderContraPremiumModern,
};