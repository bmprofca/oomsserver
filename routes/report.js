        ...
        for (const task of paginatedSlice) {
            ...
            finalData.push({
                ...
                financials: {
                    ...
                    tax_rate: parseFloat(task.tax_rate || 0),
                    tax_value: parseFloat(task.tax_value || 0),
        ...
        if (type === "staff" || type === "both") {
            ...
            const [allStaffDetails] = await pool.query(
                `SELECT 
                    ...
                    COALESCE(SUM(t.tax_value), 0) as total_tax,
                    COALESCE(SUM(t.total), 0) as total_sales,
